...
The names themselves can be changed by editing them within the [RMarkdown file]() itself and re-knitting the html file. Currently name1 <- "Marie" and name2 <- "Anna".
